"""
Django settings for advanzBackend project.
...
SECRET_KEY = 'django-insecure-fyii%xl0ts0=&(s6u@a(4x9w_=fmheo44arocr--o!5$99y5$&'
...
MIDDLEWARE = [
    ...
    'channels.middleware.protocol.ProtocolMiddleware',
]
...
# EMAIL: advanzmedicalcenter1@gmail.com
# PASSWORD :ddlzximnshetwzwk
...
EMAIL_HOST_PASSWORD = 'ddlzximnshetwzwk'
EMAIL_USE_TLS = True
